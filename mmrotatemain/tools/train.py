...
# from mmrotatemain.configs.rotated_imted import rotated_imted_oriented_rcnn_vit_small_1x_dota_le90_8h as cfg

def parse_args():
    parser = argparse.ArgumentParser(description='Train a detector')
    parser.add_argument('config', help='train config file path',default=r'mmrotatemain/configs/rotated_imted/rotated_imted_oriented_rcnn_vit_small_1x_dota_le90_8h.py')
