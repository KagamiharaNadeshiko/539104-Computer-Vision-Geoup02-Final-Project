...
# dota_ms_rr
data_root_ms = ('E:/学习资料杂项/课程资料/毕业设计/Spatial-Transform-Decoupling-main/Spatial-Transform-Decoupling-main/mmrotatemain'
                '/data/dxc/')
data_root_ss = ('E:/学习资料杂项/课程资料/毕业设计/Spatial-Transform-Decoupling-main/Spatial-Transform-Decoupling-main/mmrotatemain'
                '/data/dxc/')
...
data = dict(
    ...
    val=dict(
        ...
        version=angle_version),
    test=dict(
        ann_file=data_root_ms + 'test/annfiles/',
