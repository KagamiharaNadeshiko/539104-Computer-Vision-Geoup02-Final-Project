...
data = dict(
    ...
    val=dict(
        type='DOTADataset',
        ann_file='./mmrotatemain/data/dxc/val/annfiles/',
        img_prefix='./mmrotatemain/data/dxc/val/images/',
        pipeline=test_pipeline,
        version='le90'),
    test=dict(
        type='DOTADataset',
        ann_file='./mmrotatemain/data/dxc/test/annfiles/',
        img_prefix='./mmrotatemain/data/dxc/test/images/',
        pipeline=test_pipeline,
        version='le90'))
optimizer = dict(
    type='AdamW',
